...
public class Bid {
    ...
    public Bid(Integer id, String no, String mode, Integer userId, String yqUser, String doc, Integer topCate, String proName, String proAddress, Date beginTime, Date endTime, Date openTime, String bidRequire, String proBrief, String bidContent, Integer packType, String eq, Date docBegin, BigDecimal docPrice, BigDecimal supplyBail, Integer openWay, String payWay, String other, String bidPerson, String contPerson, String contAddress, String contEmail, String contPhone, String contTax, String agent, String agentPerson, String agentAddress, String agentEmail, String agentPhone, String agentTax, BigDecimal bail, String bailPayWay, Integer bailIsRefund, Integer status, Date createTime, Integer admin, String adminMessage, String shopId) {
        this.id = id;
        this.no = no;
        this.mode = mode;
        this.userId = userId;
