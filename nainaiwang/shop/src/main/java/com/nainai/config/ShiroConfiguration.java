...
//
//    // cas server地址
//    public static final String casServerUrlPrefix = "https://localhost:8443";
//    // Cas登录页面地址
//    public static final String casLoginUrl = casServerUrlPrefix + "/cas/login";
//    // Cas登出页面地址
//    public static final String casLogoutUrl = casServerUrlPrefix + "/cas/logout";
//    // 当前工程对外提供的服务地址
//    public static final String shiroServerUrlPrefix = "http://127.0.0.1:8082";
//    // casFilter UrlPattern
//    public static final String casFilterUrlPattern = "/index.html";
//    // 登录地址
