...
//    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager, CasFilter casFilter, UserMapper userMapper) {
...
//        filterChainDefinitionMap.put("/shopinfo/**", "anon");
//
